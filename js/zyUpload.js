		...
		return this.each(function(){
			...
			this.createHtml = function(){
				...
				if(para.dragDrop){
	            	...
	            	html += '				<div class="w">';
	            	html += '					<div class="p24">';
	            	html += '						<div class="filePicker borxx font_30 alic"><img src="images/camera.png"></div>';
	            	html += '						<input id="fileImage" type="file" style="display:none" size="30" name="fileselect[]" '+multiple+'>';
	            	html += '					</div>';
	            	html += '				</div>';
					html += '			</div>';
					html += '			<div id="preview" class="upload_preview ty"></div>';
					html += '		</div>';
			...
			this.funDisposePreviewHtml = function(file, e){
				...
				if (file.type.indexOf("image") == 0) {
					...
					html += '			<p class="file_name font_28">' + file.name + '</p>';
